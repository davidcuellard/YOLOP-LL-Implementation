...
_C.DATASET.DATAROOTBDD = main_folder + '/dataset_bdd/images'       # the path of images folder
_C.DATASET.LABELROOTBDD = main_folder + '/dataset_bdd/det_annotations_ll'      # the path of det_annotations folder
_C.DATASET.MASKROOTBDD =  main_folder + '/dataset_bdd/lane_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOTBDD = main_folder + '/dataset_bdd/lane_gt'               # the path of ll_seg_annotations folder
_C.DATASET.DATAROOTDEMO = main_folder + '/myDS-demo/images'       # the path of images folder
_C.DATASET.LABELROOTDEMO = main_folder + '/myDS-demo/det_annotations_ll'      # the path of det_annotations folder
_C.DATASET.MASKROOTDEMO =  main_folder + '/myDS-demo/lane_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOTDEMO = main_folder + '/myDS-demo/lane_gt'               # the path of ll_seg_annotations folder
_C.DATASET.DATASET = 'BddDataset'
_C.DATASET.TRAIN_SET = 'train'
_C.DATASET.TEST_SET = 'val'
_C.DATASET.DATA_FORMAT = 'jpg'
_C.DATASET.SELECT_DATA = False
_C.DATASET.ORG_IMG_SIZE = [1944, 2592]
